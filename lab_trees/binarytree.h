...
class BinaryTree
{
    public:
        ...
        int  isOrderedBig(Node* subRoot) const;

        int  isOrderedSmall(Node* subRoot) const;
        ...
        void _Paths(Node* subRoot, std::vector<std::vector<T>>& paths, T array[], int index_ ) const;
        /**
        ...
        int _sumDistances(int height, Node* subRoot, int sum) const;
